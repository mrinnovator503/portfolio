(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
    ...
    let e,
      ...
      y = { ...l, transform: (t) => Math.round(a(0, 255, t)) },
      g = {
        test: m("rgb", "red"),
      ...
      M = {
        test: (t) => g.test(t) || v.test(t) || A.test(t),
        parse: (t) =>
          g.test(t) ? g.parse(t) : A.test(t) ? A.parse(t) : v.parse(t),
        transform: (t) =>
          "string" == typeof t
            ? t
    ...
    let j = {
        test: function (t) {
          return (
            isNaN(t) &&
            "string" == typeof t &&
            (t.match(c)?.length || 0) + (t.match(C)?.length || 0) > 0
          );
        },
        parse: function (t) {
          return D(t).values;
    ...
    let O = /\b([a-z-]*)\(.*?\)/gu,
      ...
      H = () => ({ x: Y(), y: Y() }),
      K = (t) => !!(t && t.getVelocity),
      q = new Set(["width", "height", "top", "left", "right", "bottom", ...r]),
      G = (t) => (e) => e.test(t),
      Z = [l, T, b, w, S, P, { test: (t) => "auto" === t, parse: (t) => t }],
      J = (t) => Z.find(G(t));
    var Q,
      tt = t.i(47167);
    let te = () => {},
    ...
    function tF() {
      ...
      ((tj = !1), (tL = !1), tD.forEach((t) => t.complete(tB)), tD.clear());
    }
    function tO() {
      tD.forEach((t) => {
    ...
    class tI {
      ...
      scheduleResolve() {
        ((this.state = "scheduled"),
          this.isAsync
            ? (tD.add(this),
              tL || ((tL = !0), tC.read(tO), tC.resolveKeyframes(tF)))
    ...
    class tY {
      ...
      add(t) {
        return (t_(this.subscriptions, t), () => tX(this.subscriptions, t));
      }
      notify(t, e, i) {
    ...
    class t8 extends t0 {
      ...
      set time(t) {
        ...
        ((this.manualStartTime = null),
          (this.finishedTime = null),
          (this.animation.currentTime = tz(t)),
    ...
    let ei = {
      now: () => (
        void 0 === i &&
          ei.set(
            tV.isProcessing || tE.useManualTiming
              ? tV.timestamp
              : performance.now(),
          ),
        i
      ...
      update(t, e) {
        ...
        ((this.prevMotionValues = (function (t, e, i) {
          for (let n in e) {
            ...
            else if (K(r)) t.addValue(n, es(s, { owner: t }));
            else if (r !== s)
              if (t.hasValue(n)) {
                let e = t.getValue(n);
      ...
      readValue(t, e) {
        ...
        if (null != i) {
          ...
          if (
            ...
            let n;
            ((n = i), !er.find(G(n)) && j.test(e) && (i = t$(t, e)));
          }
    ...
    class eN extends eb {
      ...
      readValueFromInstance(t, e) {
        ...
        return ((e = eR.has(e) ? e : eT(e)), t.getAttribute(e));
      }
      scrapeMotionValuesFromProps(t, e, i) {
        return e$(t, e, i);
      }
      ...
      renderInstance(t, e, i, n) {
        for (let i in (eL(t, e, void 0, n), e.attrs))
          t.setAttribute(eR.has(i) ? i : eT(i), e.attrs[i]);
      }
      mount(t) {
    ...
    function eH(t, e, i, n, s) {
      return (void 0 !== s && (t = n + s * (t - n)), n + i * (t - n) + e);
    }
    function eK(t, e = 0, i = 1, n, s) {
      ((t.min = eH(t.min, e, i, n, s)), (t.max = eH(t.max, e, i, n, s)));
    }
    ...
    t.s(["LayoutGroupContext", 0, e6], 31178);
    let e9 = (0, e2.createContext)({ strict: !1 }),
      e8 = (0, e2.createContext)({
        transformPagePoint: (t) => t,
        isStatic: !1,
        reducedMotion: "never",
      });
    t.s(["MotionConfigContext", 0, e8], 13383);
    let e7 = (0, e2.createContext)({});
    function it(t) {
    ...
    function ii(t, e, i) {
      for (let n in e) K(e[n]) || eI(n, i) || (t[n] = e[n]);
    }
    let is = () => ({ ...ie(), attrs: {} }),
      ir = new Set([
        "animate",
    ...
    (t.s(["PresenceContext", 0, ih], 21476),
      t.s(["useConstant", 0, iu], 47414));
    let id = (t) => (e, i) => {
        let n = (0, e2.useContext)(e7),
      ...
      ic = id({ scrapeMotionValuesFromProps: eU, createRenderState: ie }),
      ip = id({ scrapeMotionValuesFromProps: e$, createRenderState: is }),
      im = {
        animation: [
          "animate",
          "variants",
    ...
    let iv = Symbol.for("motionComponentSymbol"),
      ix = "data-" + eT("framerAppearId"),
    ...
    let iT = "u" > typeof window ? e2.useLayoutEffect : e2.useEffect;
    function iP(t, { forwardMotionProps: e = !1, type: i } = {}, n, s) {
      n &&
        (function (t) {
          let e = ig();
      ...
      function a(i, n) {
        ...
        if (!c && "u" > typeof window) {
          (0, e2.useContext)(e9).strict;
          let e = (function (t) {
            let { drag: e, layout: i } = ig();
            if (!e && !i) return {};
            let n = { ...e, ...i };
            return {
              MeasureLayout:
          ...
          ((l = e.MeasureLayout),
            (p.visualElement = (function (t, e, i, n, s, r) {
              let { visualElement: o } = (0, e2.useContext)(e7),
                a = (0, e2.useContext)(e9),
        ...
        return (0, e4.jsxs)(e7.Provider, {
          value: p,
          children: [
            l && p.visualElement
              ? (0, e4.jsx)(l, { visualElement: p.visualElement, ...d })
              : null,
                  ...
                  (o ?? e3(t))
                    ? function (t, e, i, n) {
                        let s = (0, e2.useMemo)(() => {
                          let i = is();
                          return (
                            eV(i, e, eD(n), t.transformTemplate, t.style),
    ...
    t.s(["useIsomorphicLayoutEffect", 0, iT], 74008);
    class iS {
      constructor(t) {
    ...
    let iX = (t) => {
      ...
      return {
        ...
        stop: () => tk(e),
        now: () => (tV.isProcessing ? tV.timestamp : ei.now()),
      };
    };
    function iY(t) {
      let e = 0,
    ...
    function i1(t = 0.3, e = 0.3) {
      let i,
        ...
        S = Math.sqrt(f / g) / 1e3,
        E = 5 > Math.abs(P);
      if ((u || (u = E ? iH : iK), d || (d = E ? iq : iG), T < 1))
        ((s = iZ(S, T)),
          (r = (b + T * S * P) / s),
          (i = (t) =>
            p -
            Math.exp(-T * S * t) * (r * Math.sin(s * t) + P * Math.cos(s * t))),
          (o = T * S * r + P * s),
          (l = T * S * P - r * s),
          (n = (t) =>
            Math.exp(-T * S * t) *
            (o * Math.sin(s * t) + l * Math.cos(s * t))));
      else if (1 === T) {
        i = (t) => p - Math.exp(-S * t) * (P + (b + S * P) * t);
        let t = b + S * P;
        n = (e) => Math.exp(-S * e) * (S * t * e - b);
      } else {
        let t = S * Math.sqrt(T * T - 1);
        i = (e) => {
          let i = Math.exp(-T * S * e),
            n = Math.min(t * e, 300);
          return (
            p -
            (i * ((b + T * S * P) * Math.sinh(n) + t * P * Math.cosh(n))) / t
          );
        };
        let e = (b + T * S * P) / t,
          s = T * S * e - P * t,
      ...
      let A = {
        ...
        next: (t) => {
          if (!w && T < 1) {
            let e = Math.exp(-T * S * t),
              i = Math.sin(s * t),
              n = Math.cos(s * t),
              a = p - e * (r * i + P * n);
            return (
              (m.done =
                Math.abs(tz(e * (o * i + l * n))) <= u && Math.abs(p - a) <= d),
              (m.value = m.done ? p : a),
              m
            );
          }
          ...
          return (
            w
              ? (m.done = t >= v)
              : (m.done = Math.abs(tz(n(t))) <= u && Math.abs(p - e) <= d),
            (m.value = m.done ? p : e),
            m
          );
        },
        toString: () => {
          let t = Math.min(iY(A), 2e4),
        ...
        h = (function (t, e, { clamp: i = !0, ease: n, mixer: s } = {}) {
          ...
          e,
          {
            ease: Array.isArray(o)
              ? o
              : e.map(() => o || i8).splice(0, e.length - 1),
          },
        );
      return {
    ...
    let nc = { decay: i5, inertia: i5, tween: nd, keyframes: nd, spring: i1 };
    function np(t) {
    ...
    class nf extends t0 {
      ...
      initAnimation() {
        ...
        a !== nd &&
          "number" != typeof o[0] &&
          ((this.mixKeyframes = iR(nm, i_(o[0], o[1]))), (o = [0, 100]));
      ...
      tick(t, e = !1) {
        ...
        return (
          P && f !== i5 && (i.value = tQ(d, this.options, g, this.speed)),
          y && y(i.value),
          P && this.finish(),
          i
        );
    ...
    let nw = /^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/,
      ...
      nT = tK(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
    class nP extends t0 {
      constructor({
        autoplay: t = !0,
        delay: e = 0,
      ...
      onKeyframesResolved(t, e, i, n) {
        ...
        !(function (t, e, i, n) {
          ...
          ((d = !1),
          (tE.instantAnimations || !l) && u?.(tQ(t, i, e)),
          (t[0] = t[t.length - 1]),
          nx(i),
          (i.repeat = 0));
        let c = {
      ...
      get animation() {
        return (
          this._animation ||
            (this.keyframeResolver?.resume(), (tB = !0), tO(), tF(), (tB = !1)),
          this._animation
        );
      }
      get duration() {
      ...
      nC =
        ...
        (a) => {
          ...
          (!(function (t) {
            ...
            d.duration && (d.duration = tz(d.duration)),
            d.repeatDelay && (d.repeatDelay = tz(d.repeatDelay)),
    ...
    function nk(t, e, { delay: i = 0, transitionOverride: n, type: s } = {}) {
      ...
      for (let e in a) {
        ...
        n.start(nC(e, n, s, p && q.has(e) ? { type: !1 } : o, t, c));
        let m = n.animation;
        m && u.push(m);
      }
      if (o) {
    ...
    function nR(t, e, i = {}) {
      ...
      let r = n ? () => Promise.all(nk(t, n, i)) : () => Promise.resolve(),
        o =
    ...
    function nX(t, e, i, n = 0) {
      ((t.min = (n ? eF(i.min, i.max, n) : i.min) + e.min),
        (t.max = t.min + nW(e)));
    }
    function nY(t, e, i, n = 0) {
      let s = n ? eF(i.min, i.max, n) : i.min;
    ...
    function n3(t, e) {
      ...
      return "function" == typeof t
        ...
        : (!n && "u" > typeof ResizeObserver && (n = new ResizeObserver(n2)),
          (i = nG(t)).forEach((t) => {
            let i = nZ.get(t);
            (i || ((i = new Set()), nZ.set(t, i)), i.add(e), n?.observe(t));
          }),
          () => {
            i.forEach((t) => {
              let i = nZ.get(t);
    ...
    let n4 = new Set(["BUTTON", "INPUT", "SELECT", "TEXTAREA", "A"]),
    ...
    function n7(t, e, i, n) {
      return n$(t, e, (t) => n9(t) && i(t, n8(t)), n);
    }
          ...
          (this.updatePoint = () => {
            ...
            let i = so(this.lastMoveEventInfo, this.history),
              ...
              s =
                ((t = i.offset),
                (e = { x: 0, y: 0 }),
                Math.sqrt(se(t.x, e.x) ** 2 + se(t.y, e.y) ** 2) >=
    ...
    function so({ point: t }, e) {
      return {
        ...
        velocity: (function (t) {
          ...
          for (
            ;
            e >= 0 && ((i = t[e]), !(n.timestamp - i.timestamp > tz(0.1)));
          )
            e--;
          if (!i) return { x: 0, y: 0 };
          i === t[0] &&
            t.length > 2 &&
            n.timestamp - i.timestamp > 2 * tz(0.1) &&
            (i = t[1]);
    ...
    class sp {
      ...
      resolveRefConstraints() {
        ...
        if (i) {
          ...
          ((this.hasMutatedConstraints = !!t), t && (o = eW(t)));
        }
        return o;
      }
      startAnimation(t) {
      ...
      startAxisValueAnimation(t, e) {
        ...
        return (
          ...
          i.start(nC(t, i, 0, e, this.visualElement, !1))
        );
      }
      stopAnimation() {
        ...
        let e = this.visualElement.current,
          i = n7(e, "pointerdown", (t) => {
            let { drag: i, dragListener: n = !0 } = this.getProps(),
              s = t.target,
              r = s !== e && (n6.has(s.tagName) || !0 === s.isContentEditable);
            i && n && !r && this.start(t);
          }),
          n = () => {
            var i, n, s;
            ...
            ib(a) &&
              ...
              t ||
                ...
                (r = n3(
                  i,
                  sm((s = () => this.scalePositionWithinConstraints())),
                )),
                (o = n3(n, sm(s))),
                (t = () => {
                  (r(), o());
    ...
    t.s(["usePresence", 0, sx], 64978);
    let sw = !1;
    class sb extends sv.Component {
      componentDidMount() {
        let {
            visualElement: t,
            layoutGroup: e,
    ...
    function sI(t, e, i, n) {
      (sB(t.x, e, sF, i ? i.x : void 0, n ? n.x : void 0),
        sB(t.y, e, sO, i ? i.y : void 0, n ? n.y : void 0));
    }
    function sU(t) {
      ...
      return class {
            ...
            !1 !== this.options.animate &&
              ...
              this.addEventListener(
                ...
                ({
                  ...
                  let r =
                      this.options.transition || s.getDefaultTransition() || ra,
                    {
                  ...
                  if (
                    ...
                    let e = { ...iM(r, "layout"), onPlay: o, onComplete: a };
        ...
        update() {
          ...
          ((this.animationCommitId = this.animationId),
            ...
            this.clearAllSnapshots());
          let t = ei.now();
          ((tV.delta = a(0, 1e3 / 60, t - tV.timestamp)),
            (tV.timestamp = t),
            (tV.isProcessing = !0),
            tR.update.process(tV),
            tR.preRender.process(tV),
            tR.render.process(tV),
            (tV.isProcessing = !1));
        }
        didUpdate() {
        ...
        clearAllSnapshots() {
          (this.nodes.forEach(s5), this.sharedNodes.forEach(rn));
        }
        ...
        removeElementScroll(t) {
          ...
          for (let i = 0; i < this.path.length; i++) {
            ...
            n !== this.root &&
              s &&
              r.layoutScroll &&
              (s.wasRoot && sD(e, t), eG(e.x, s.offset.x), eG(e.y, s.offset.y));
          }
          return e;
        }
        applyTransform(t, e = !1, i) {
          ...
          for (let t = 0; t < this.path.length; t++) {
            ...
            (!e &&
              ...
              i.scroll &&
              i !== i.root &&
              (eG(n.x, -i.scroll.offset.x), eG(n.y, -i.scroll.offset.y)),
              eX(i.latestValues) && eQ(n, i.latestValues, i.layout?.layoutBox));
          }
          return (
            eX(this.latestValues) &&
              eQ(n, this.latestValues, this.layout?.layoutBox),
            n
          );
        }
        removeTransform(t) {
          ...
          for (let t = 0; t < this.path.length; t++) {
            ...
            eX(n.latestValues) &&
              (n.instance &&
                ...
                sD((i = H()), n.measurePageBox())),
              sI(e, n.latestValues, n.snapshot?.layoutBox, i));
          }
          return (eX(this.latestValues) && sI(e, this.latestValues), e);
        }
        setTargetDelta(t) {
          ((this.targetDelta = t),
        ...
        forceRelativeParentToResolveTarget() {
          this.relativeParent &&
            this.relativeParent.resolvedRelativeTargetAt !== tV.timestamp &&
        ...
        resolveTargetDelta(t = !1) {
          ...
          this.resolvedRelativeTargetAt = tV.timestamp;
        ...
        calcProjection() {
          ...
          if (
            ...
            e &&
              ...
              (i = !1),
            this.resolvedRelativeTargetAt === tV.timestamp && (i = !1),
            i)
          )
            return;
          let { layout: n, layoutId: s } = this.options;
              ...
              for (let a = 0; a < o; a++) {
                ...
                (!o ||
                  ...
                  (n &&
                    ...
                    s.scroll &&
                    s !== s.root &&
                    (eG(t.x, -s.scroll.offset.x), eG(t.y, -s.scroll.offset.y)),
              ...
              if (
                ...
                (nH(
                  ...
                  i &&
                    ...
                    (this.isProjectionDirty = !1),
                  i || (i = H()),
                  sD(i, this.relativeTarget));
              }
              (l &&
                ((this.animationValues = r),
                (function (t, e, i, n, s, r) {
                  s
                    ? ((t.opacity = eF(0, i.opacity ?? 1, sC(n))),
                      (t.opacityExit = eF(e.opacity ?? 1, 0, sk(n))))
    ...
    function s0(t) {
      ...
      if (t.isLead() && t.layout && e && t.hasListeners("didUpdate")) {
        ...
        let a = X();
        r
          ? n_(a, t.applyTransform(n, !0), e.measuredBox)
          : n_(a, i, e.layoutBox);
        let l = !s$(o),
          h = !1;
        if (!t.resumeFrom) {
    ...
    function rd(t, e, i) {
      return (
        "position" === t ||
        ("preserve-aspect" === t && !(0.2 >= Math.abs(s_(e) - s_(i))))
      );
    }
    function rc(t) {
      ...
      rR = (function (t, e) {
        ...
        return new Proxy((t, e) => n(t, e), {
          get: (s, r) =>
            "create" === r
              ? n
              : (i.has(r) || i.set(r, iP(r, void 0, t, e)), i.get(r)),
        });
      })(
        {
          animation: {
              ...
              startObserver() {
                ...
                let { viewport: i = {} } = this.node.getProps(),
                  ...
                  a = {
                    ...
                    rootMargin: s,
                    threshold: "number" == typeof r ? r : rV[r],
                  },
                  l = (t) => {
                ...
                this.stopObserver =
                  ...
                  (e = (function ({ root: t, ...e }) {
                    ...
                    return (
                      n[s] ||
                        (n[s] = new IntersectionObserver(rk, {
                          root: t,
                          ...e,
                        })),
                      n[s]
                    ...
                    return (
                      n.forEach((t) => {
                        ...
                        (t.addEventListener(
                          "pointerenter",
                          (n) => {
                            if ("touch" === n.pointerType || nN.x || nN.y)
                              return;
                            r = !1;
                            let o = e(t, n);
                            "function" == typeof o &&
  ...
  (t) => {
    ...
    function c({
      ...
      let p = (0, l.useId)(),
        ...
        { nonce: y } = (0, l.useContext)(h.MotionConfigContext),
        g = (function (...t) {
      ...
      return (
        (0, l.useInsertionEffect)(() => {
          ...
          let d = "left" === s ? `left: ${l}` : `right: ${h}`,
            c = "bottom" === r ? `bottom: ${u}` : `top: ${i}`;
        ...
        (0, e.jsx)(d, {
          ...
          sizeRef: f,
          pop: a,
          children: !1 === a ? t : l.cloneElement(t, { ref: g }),
        })
      );
    }
    let p = ({
    ...
    t.s(
      [
        ...
        ({
          ...
          let [x, w] = (0, f.usePresence)(d),
            b = (0, i.useMemo)(() => g(t), [t]),
            T = d && !x ? [] : b.map(y),
            P = (0, i.useRef)(!0),
            S = (0, i.useRef)(b),
            E = (0, s.useConstant)(() => new Map()),
          ...
          if (b !== M) {
            ...
            return ("wait" === u && R.length && (t = R), V(g(t)), C(b), null);
          }
          let { forceRender: D } = (0, i.useContext)(n.LayoutGroupContext);
          return (0, e.jsx)(e.Fragment, {
            children: k.map((t) => {
              let i = y(t),
                n = (!d || !!x) && (b === k || T.includes(i));
              return (0, e.jsx)(
                p,
                {
                  isPresent: n,
                  ...
                  onExitComplete: n
                    ? void 0
                    : () => {
                        if (A.current.has(i) || !E.has(i)) return;
                        (A.current.add(i), E.set(i, !0));
                        let t = !0;
                        (E.forEach((e) => {
                          e || (t = !1);
                        }),
                          t && (D?.(), V(S.current), d && w?.(), l && l()));
                      },
                  anchorX: c,
                  anchorY: m,
                  children: t,
  ...
  (t) => {
    ...
    let r = (0, e.createContext)({}),
      o = (0, e.forwardRef)(
        (
          ...
          let {
            ...
            v = (a ?? f) ? (24 * Number(o ?? m)) / Number(n ?? p) : (o ?? m);
      ...
      a = (t, s) => {
        let r = (0, e.forwardRef)(({ className: r, ...a }, l) =>
          (0, e.createElement)(o, {
            ref: l,
            iconNode: s,
            className: i(
  ...
  (t, e, i) => {
    ...
    function g(e) {
      ...
      let s,
        r,
        g,
        [x, w] = (0, a.useOptimistic)(m.IDLE_LINK_STATUS),
        b = (0, a.useRef)(null),
        {
          href: T,
          as: P,
      ...
      ((s = S),
        L &&
          ...
          (s = (0, o.jsx)("a", { children: s })));
      let U = a.default.useContext(h.AppRouterContext),
        $ = !1 !== E,
        N =
          !1 !== E
            ? null === (n = E) || "auto" === n
            ...
            : y.FetchStrategy.PPR,
        W = "string" == typeof (i = P || T) ? i : (0, l.formatUrl)(i);
      if (L) {
        ...
        r = a.default.Children.only(s);
      }
      let z = L ? r && "object" == typeof r && r.ref : F,
        _ = a.default.useCallback(
          (t) => (
            null !== U &&
              (b.current = (0, m.mountLinkInstance)(t, W, U, N, $, w)),
            () => {
              (b.current &&
                ((0, m.unmountLinkForCurrentNavigation)(b.current),
                (b.current = null)),
                (0, m.unmountPrefetchableInstance)(t));
            }
          ),
          [$, W, U, N, w],
        ),
        X = {
          ref: (0, u.useMergedRef)(_, z),
          onClick(e) {
            (L || "function" != typeof V || V(e),
              L &&
                r.props &&
              ...
              !U ||
                ...
                (function (e, i, n, s, r, o, l) {
                  if ("u" > typeof window) {
                    ...
                    let { dispatchNavigateAction: d } = t.r(99781);
          ...
          onMouseEnter(t) {
            (L || "function" != typeof R || R(t),
              L &&
                r.props &&
                "function" == typeof r.props.onMouseEnter &&
                r.props.onMouseEnter(t),
              U && $ && (0, m.onNavigationIntent)(t.currentTarget, !0 === O));
          },
          onTouchStart: function (t) {
            (L || "function" != typeof D || D(t),
              L &&
                r.props &&
      ...
      return (
        (0, d.isAbsoluteUrl)(W)
          ? (X.href = W)
          : (L && !A && ("a" !== r.type || "href" in r.props)) ||
            (X.href = (0, c.addBasePath)(W)),
        (g = L
          ? a.default.cloneElement(r, X)
          : (0, o.jsx)("a", { ...I, ...X, children: s })),
        (0, o.jsx)(v.Provider, { value: x, children: g })
      );
    }
    t.r(84508);
